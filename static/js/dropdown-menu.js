...
function DropdownMenuGroup(props) {
  return React.createElement(DropdownMenuPrimitive.Group, { "data-slot": "dropdown-menu-group", ...props });
}
...
function DropdownMenuRadioGroup(props) {
  return React.createElement(DropdownMenuPrimitive.RadioGroup, { "data-slot": "dropdown-menu-radio-group", ...props });
}
...
function DropdownMenuSubTrigger({ className, inset, children, ...props }) {
  return React.createElement(DropdownMenuPrimitive.SubTrigger, {
    ...
    ...props
  }, children, React.createElement(ChevronRightIcon, { className: "ml-auto size-4" }));
}
